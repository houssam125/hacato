  ...
  return (
    <div className="min-h-full flex flex-col bg-gray-100 p-3 sm:p-6" dir="ltr">
      ...
      <div className="mb-4 sm:mb-6 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Group Management</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">View, create, and update groups.</p>
        </div>
        <button
